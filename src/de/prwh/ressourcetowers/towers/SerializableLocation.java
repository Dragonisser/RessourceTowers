...
public class SerializableLocation implements Serializable {
	...
	/**
	 * Creates a new instance based on the given string. The general contract of
	 * this method is that if the output of the {@link #toString()} is passed it
	 * will result in a clone.
	 * 
	 * @param string
	 *            the String.
	...
	/**
	 * <p>
	 * The following types can be used to compare the instance with the passed
	 * value:
	 * </p>
	 * <ul>
	 * <li><b>SerializableLocation:</b> All values will be compared.</li>
	 * <li><b>Location:</b> All values will be compared by internally creating a
	 * new instance of SerializableLocation based on the given Location.</li>
	...
	/**
	 * @return the World object of this instance or null if there is no world
...
//		return result;
	 ...
	 * [worldname][space][x][space][y][space][z][space][pitch][space][yaw]
	 * 
